...
function populateMenu(arr) {
  ...
  arr.forEach(function (e) {
    menu.appendChild(e[Object.keys(e)[0]]);
  });
}
...
function createCards() {
  ...
  allCards.card2 = new Card('card2', 'Book Club', 'http://i.imgur.com/OwJhNO3.png', ['Meteor', 'React', 'Material UI', 'Bootstrap'], 'an other very cool looking site', 'site-url.com', 'SITE-GIT.COM');

  allCards.card3 = new Card('card3', 'Stock Market Graph', 'http://i.imgur.com/sjDdLml.png', ['Meteor', 'React', 'Material UI', 'Bootstrap', 'Highcharts'], 'an other very cool looking site', 'site-url.com', 'SITE-GIT.COM');

  allCards.card4 = new Card('card4', 'Poll App', 'http://i.imgur.com/u70EtYy.png', ['Meteor', 'React', 'Material UI', 'Bootstrap', 'D3'], 'an other very cool looking site', 'site-url.com', 'SITE-GIT.COM');
